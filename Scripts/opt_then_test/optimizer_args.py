...
def get_parser():
    ...
    To add constant parameters, place a dictionary under key 'parameters'
    To remove parameters, place a list of the parameters' names in a list under key 'remove'."""
    #Set up arguments
    parser = argparse.ArgumentParser(description=description,epilog=epilog)
    #Positional arguments
    parser.add_argument('system', type=str, help='System to use. Must be one of "lorenz", "rossler", "thomas", "softrobot", or a .pkl file containing a templates.System object, or a .py file defining a templates.System object named "system".')
    ...
    parser.add_argument('--no-timestamp', help='Do not include a timestamp in file and folder names', action='store_false')
